...
class DownloadCache(
    ...
    fun isChapterDownloaded(
        ...
        if (sourceDir != null) {
            val mangaDir = provider.getValidMangaDirNames(manga).firstNotNullOfOrNull {
                sourceDir.files[it]
            }
            if (mangaDir != null) {
