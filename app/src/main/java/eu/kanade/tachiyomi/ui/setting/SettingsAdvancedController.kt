        ...
        with(screen) {
            ...
            preferenceCategory {
                ...
                listPreference {
                    ...
                    defaultValue =
                        if (MiuiUtil.isMiui() || (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
            ...
            preferenceCategory {
                ...
                switchPreference {
                    ...
                    defaultValue = true
                    summary = "Apply ${context.getString(
                        R.string.app_name
                    )} enhancements to the following sources if they are installed: ${DELEGATED_SOURCES.values.map { it.sourceName }.distinct().joinToString()}"
                }
                ...
                intListPreference {
                    ...
                    entries =
                        EHLogLevel.values().map { ehLogLevel ->
